    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link <?php if (strpos($_SERVER['PHP_SELF'], 'home/officer_account.php') !== false || strpos($_SERVER['PHP_SELF'], 'home/student_account.php') !== false || strpos($_SERVER['PHP_SELF'], 'home/parent_account.php') !== false)  { echo 'active'; } else { echo 'collapsed'; } ?>" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                    <div class="sb-nav-link-icon"><i class="fas fa-user"></i></div>
                    Account
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="<?php if (strpos($_SERVER['PHP_SELF'], 'home/officer_account.php') !== false || strpos($_SERVER['PHP_SELF'], 'home/student_account.php') !== false || strpos($_SERVER['PHP_SELF'], 'home/parent_account.php') !== false)  { echo 'show'; } else { echo 'collapse'; } ?>" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link <?php if (strpos($_SERVER['PHP_SELF'], 'home/officer_account.php') !== false)  { echo 'active'; } ?>" href="officer_account">Officer</a>
                        <a class="nav-link <?php if (strpos($_SERVER['PHP_SELF'], 'home/parent_account.php') !== false)  { echo 'active'; } ?>" href="parent_account">Parent</a>
                        <a class="nav-link <?php if (strpos($_SERVER['PHP_SELF'], 'home/student_account.php') !== false)  { echo 'active'; } ?>" href="student_account">Student</a>
                        <a class="nav-link <?php if (strpos($_SERVER['PHP_SELF'], 'home/user_account.php') !== false)  { echo 'active'; } ?>" href="user_account">User</a>
                    </nav>
                </div>
