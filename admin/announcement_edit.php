            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="col-md-6 mb-3">
                                ...
                                <input required type="datetime-local" name="date_start" id="txtDate" value="<?= $user['date_start']; ?>" class="form-control">
                                
                    </div>
                    
                    <div class="col-md-6 mb-3">
                                <label for="">Date Ended</label>
                                <input required type="datetime-local" name="date_end" id="txtDate" value="<?= $user['date_end']; ?>" class="form-control">
                    </div>
                     ...
                     <div class="text-right">
                                ...
                                <button type="submit" name="update_ann" class="btn btn-primary">Update</button>
                                </div>
                </form>
                <?php
                                }
