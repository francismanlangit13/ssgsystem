                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input required type="text" id="student" name="student_id" value="<?=$user['student_id'];?>" class="form-control">
                                            ...
                                            <div class="float-end">
                                                ...
                                                <button type="submit" id="submit-btn" name="update_student" class="btn btn-primary"><i class="fas fa-save"></i> Update</button>
                                            </div>
                                            <br><br>
                                        </div>
                                    </form>
