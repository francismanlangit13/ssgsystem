        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <?php
                    if(isset($_GET['id'])){
                        $id = $_GET['id'];
                        $users = "SELECT * FROM user INNER JOIN user_status ON user.user_status = user_status.user_status_id WHERE user_id='$id' AND user_type = 7 AND user_status.user_status_id IN (1,2) ";
