                        ...
                        <form action="code.php" method="POST">
                            ...
                            <div class="col-md-12 mb-3 text-center">
                                ...
                                <label for=""><strong>Suffix</strong></label>
                                    <p class="form-control-plaintext"><?=$user['suff'];?></p>
                                </div>
                                ...
                                <div class="col-md-4 mb-3 text-center ">
                                <label for=""><strong>Year Level</strong></label>
                            ...
                            ?>
                                ...
                                <hr class="mt-2 mb-3"/>
                                <h2></h2>
                                <h4 class="text-center mb-4">Penalties & Balance</h4>
                                <div class="col-md-3 mb-3">
                                <label for=""><strong>Penalties:</strong></label>
                               ...
                               <i class="fa-sharp fa-solid fa-peso-sign"></i> <?=$user['balance'];?>
                                ...
                                <hr class="mt-2 mb-3"/>
                                <h4 class="text-center mb-4">Student Profile Picture</h4>
                                <div class="col-md-12 mb-3 text-center">
                                <?php 
