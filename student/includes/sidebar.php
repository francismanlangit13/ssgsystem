    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark noprint" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link <?php if (strpos($_SERVER['PHP_SELF'], 'home/index.php') !== false)  { echo 'active'; } ?>" href="<?php echo base_url ?>student/home">
                ...
                <a class="nav-link <?php if (strpos($_SERVER['PHP_SELF'], 'home/onlinepay.php') !== false || strpos($_SERVER['PHP_SELF'], 'home/onlinepay_transact.php') !== false)  { echo 'active'; } ?>" href="onlinepay">
                    <div class="sb-nav-link-icon"><i class="fas fa-solid fa-money-bill-wave"></i></div>
                    Online Pay
                </a>
