<nav class="sb-topnav navbar navbar-expand navbar-dark bg-secondary noprint">
    ...
    <div style="margin-left:1rem">
        <a href="<?php echo base_url ?>treasurer/home/"><img id="cimg" class="img-fluid card-img-top" style="margin-right:-0.3rem;" src="<?php echo base_url ?>assets/files/images/system/ssg.png" alt="" class="img-fluid"></a>
        <a class="navbar-brand ps-2" href="<?php echo base_url ?>treasurer/home/" style="font-size:13px; margin-bottom:1rem;">Supreme Student Government</a>
    </div>
    <!-- Sidebar Toggle-->
