                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row d-inline-flex justify-content-center">
                                                    <div class="col-md-6">
                                                        <a href="onlinepayment_view?id=<?=$row['payment_id'];?>" class="btn btn-info btn-icon-split"> 
                                                            <span class="icon text-white-50"></span>
                                                            <span class="text ml-2 mr-2">View</span>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <a href="onlinepayment_edit?id=<?=$row['payment_id'];?>" class="btn btn-success btn-icon-split"> 
                                                            <span class="icon text-white-50"></span>
